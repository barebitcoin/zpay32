...
import (
	...
	"github.com/barebitcoin/zpay32/input/multimutex"
	"github.com/barebitcoin/zpay32/input/syncmap"
	"github.com/barebitcoin/zpay32/keychain"
...
type MusigSessionManager struct {
	...
	musig2Sessions *syncmap.SyncMap[MuSig2SessionID, *MuSig2State]
}
...
func NewMusigSessionManager(keyFetcher PrivKeyFetcher) *MusigSessionManager {
	return &MusigSessionManager{
		...
		musig2Sessions: &syncmap.SyncMap[
